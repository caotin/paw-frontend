! function t(e, i, s) {
    ...
    1: [function(t, e, i) {
        (function(e) {
            e.page_home_loaded = 1;
            t("owl.carousel");
            page_home = {
                load: function() {
                    this.owlInit(), this.videoEvents()
                },
                owlInit: function() {
                ...
                videoEvents: function() {
                    if ($(window).outerWidth(!0) > 992) {
                        var t = document.getElementById("video");
                        // t.load(), t.play(), t.addEventListener("loadeddata", function() {
                        //     $(".video_preloader").fadeOut()
                        // }, !1)
                    }
                }
